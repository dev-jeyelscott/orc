...
import { taskSourceSchema } from "../enums/task-source.js";
...
export type CreateTask = z.infer<
  typeof createTaskSchema
>;

export type RetryRun = z.infer<
  typeof retryRunSchema
>;
...
export type TaskWithRun = z.infer<
  typeof taskWithRunSchema
>;
...
export type RunListResponse = z.infer<
  typeof runListResponseSchema
>;

export type RunDetail = z.infer<
  typeof runDetailSchema
>;
