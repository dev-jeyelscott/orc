...
/**
 * Converts expected workflow service failures into API responses while preserving unexpected errors.
 */
function sendError(
  error: unknown,
  reply: {
...
/**
 * Registers task, run, monitoring, cancellation, and retry endpoints.
 */
